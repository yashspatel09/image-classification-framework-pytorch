...
class ModelEvaluator:
    ...
    def evaluate(self, model):
        ...
        self.logger.log_event('--', metrics, 'test')  # Log the metrics

        # Plot Confusion Matrix
        class_names = [f'Class{i}' for i in range(cfg.n_classes)]
        self.metrics_plotter.plot_confusion_matrix(final_y, final_y_pred, classes=class_names, title='Test Confusion Matrix')
